...
public class ReplyServiceImpl implements ReplyService {
    ...
    public Long createBoardReply(ReplyBoardCreateDTO replyBoardCreateDTO) {
        ...
        findBoardNumber(replyBoardCreateDTO.getBno()); // Check Board Number
        if (replyBoardCreateDTO.getGno() == null || replyBoardCreateDTO.getGno() == 0) {
            ...
            findBoardReplyNumber(replyBoardCreateDTO.getRno()); // Check Board Reply Number
    ...
    public Long deleteBoardReply(Long rno) {
        ...
        findBoardReplyNumber(rno); // Check Board Reply Number
    ...
    public Long createNoticeReply(ReplyNoticeCreateDTO replyNoticeCreateDTO) {
        ...
        findNotceNumber(replyNoticeCreateDTO.getNno()); // Check Notice Number
        if (replyNoticeCreateDTO.getGno() == null || replyNoticeCreateDTO.getGno() == 0) {
            ...
            findNoticeReplyNumber(replyNoticeCreateDTO.getRno()); // Check Notice Reply Number
    ...
    public Long deleteNoticeReply(Long rno) {
        ...
        findNoticeReplyNumber(rno); // Check Notice Reply Number
    ...
    public PageResponseDTO<ReplyNoticeListDTO> listNoticeReply(PageRequestDTO pageRequestDTO, Long nno) {
        ...
        findNotceNumber(nno); // Check Notice Number
        pageRequestDTO.setSize(10);
     ...
     */
    @Transactional(readOnly = true)
    private void findNotceNumber(Long nno) {
     ...
     */
    @Transactional(readOnly = true)
    private void findNoticeReplyNumber(Long rno) {
     ...
     */
    @Transactional(readOnly = true)
    private void findBoardReplyNumber(Long rno) {
