...
<h3>공지사항 생성</h3>
<form action="/spring/notice/create" method="post">
	<div class="form_content">
		<div class="bg-light rounded h-100 p-4">
			<label for="writer" class="form-label">공지사항 작성자</label>
		...
		<div class="bg-light rounded h-100 p-4">
			<label for="fileName" class="form-label">공지사항 이미지</label>
	...
	<div class="button_wrap p-4">
		<a href="/spring/notice/list" class="btn btn-outline-dark btnSignin">목록으로</a>
		<button type="submit" class="btn btn-dark btnAdd">공지사항 생성</button>
	</div>
</form>
