      ...
      <%@ include file="../include/header.jsp" %>
        <div class="col-12">
          ...
          <div class="my-4 search_wrap bg-body">
            <form action="/spring/member/list" method="get" class="actionForm">
                ...
                <tbody>
                  <c:forEach items="${list.list}" var="member" varStatus="status">
                    <tr>
                      ...
                      <td><a href="/spring/member/read/${member.email}">${member.email}</a></td>
        ...
        <%@ include file="../include/footer.jsp" %>
          ...
          <script>
            ...
            paging.addEventListener("click", (e) => {
              ...
              actionForm.setAttribute("action", "/spring/member/list")
              //submit
              actionForm.submit()
            })
