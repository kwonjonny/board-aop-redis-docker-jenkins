...
<form action="/spring/member/update" method="post">
	<div class="form_content">
		<div class="bg-light rounded h-100 p-4">
			...
			<input type="text" name="memberName" class="form-control" id="memberName" value="${list.memberName}">
		</div>
		<div class="bg-light rounded h-100 p-4">
			<label for="email" class="form-label">Email</label>
			<input type="email" name="email" class="form-control" id="email" value="${list.email}">
		</div>
		<div class="bg-light rounded h-100 p-4">
