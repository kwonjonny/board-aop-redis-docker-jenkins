...
public class BoardControllerTests {
    ...
    private static final String JUNIST_TEST_FILE_NAME = "Junit_Test_File.jpg";
    ...
    public void postDeleteBoardTest() throws Exception {
        ...
        // mock BoardService configuration
    ...
    public void postCreateBoardTest() throws Exception {
        ...
        BoardCreateDTO boardCreateDTO = BoardCreateDTO.builder()
                ...
                .content(JUNIT_TEST_CONTENT)
                .writer(JUNIT_TEST_WRITER)
                .fileNames(Arrays.asList(uuid + "_" + JUNIST_TEST_FILE_NAME))
                .build();
        // mock BoardService configuration
        ...
        mockMvc.perform(post("/board/create")
                ...
                .param("fileNames", uuid + "_" + JUNIST_TEST_FILE_NAME))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/board/list"))
                .andExpect(flash().attributeExists("message"));
