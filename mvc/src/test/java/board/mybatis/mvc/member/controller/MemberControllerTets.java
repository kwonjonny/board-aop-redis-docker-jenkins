...
public class MemberControllerTets {
    ...
    public void getReadMemberTest() throws Exception {
        ...
        // THEN
        // GET | 요청을 수행 후 응답 검증
        mockMvc.perform(get("/member/read/{email}", JUNIT_TEST_EMAIL_V2))
    ...
    public void getUpdateMemberTest() throws Exception {
        ...
        // THEN
        // GET | 요청을 수행 후 응답 검증
        mockMvc.perform(get("/member/update/{email}", JUNIT_TEST_EMAIL_V2))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(get("/member/list"))
                ...
                .andExpect(model().attribute("list", hasProperty("list", hasItem(
                        allOf(
                                ...
                                hasProperty("memberName", is(listGetReady.getMemberName())))))))
                .andExpect(status().isOk());
    ...
    public void postCreateMemberTest() throws Exception {
        ...
        mockMvc.perform(post("/member/create")
                ...
                .andExpect(redirectedUrl("/member/index"))
    ...
    public void postDeleteMemberTest() throws Exception {
        ...
        // WHEN & THEN
        mockMvc.perform(post("/member/delete/" + JUNIT_TEST_EMAIL_V2))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/member/index"))
                .andExpect(flash().attributeExists("message"));
    ...
    public void postUpdateMemberTest() throws Exception {
        ...
        mockMvc.perform(post("/member/update")
                ...
                .param("memberName", JUNIT_TEST_MEMBER_NAME))
                .andExpect(status().is3xxRedirection())
                .andExpect(redirectedUrl("/member/read/" + memberUpdateDTO.getEmail()))
                .andExpect(flash().attributeExists("message"));
    }
}
